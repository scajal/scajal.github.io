      ...
      <FullWidthRow>
        ...
        >
          <div className="space-y-4">
            <p className="text-sm font-medium tracking-wider uppercase text-[var(--accent)]">
              {heroData.eyebrow}
            </p>
